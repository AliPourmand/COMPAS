...
// Ablation mass-loss prescriptions
enum class ABLATION_MASS_LOSS_PRESCRIPTION : int { NONE, CLASSIC };

const COMPASUnorderedMap<ABLATION_MASS_LOSS_PRESCRIPTION, std::string> ABLATION_MASS_LOSS_PRESCRIPTION_LABEL = {
    { ABLATION_MASS_LOSS_PRESCRIPTION::NONE,    "NONE" },
    { ABLATION_MASS_LOSS_PRESCRIPTION::CLASSIC, "CLASSIC" }
};

// Ablation angular-momentum-loss prescriptions
enum class ABLATION_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION : int { KIEL_TAAM, GINZBURG_QUATAERT};

const COMPASUnorderedMap<ABLATION_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION, std::string> ABLATION_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION_LABEL = {
    { ABLATION_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION::KIEL_TAAM, "KIEL_TAAM" },
    { ABLATION_ANGULAR_MOMENTUM_LOSS_PRESCRIPTION::GINZBURG_QUATAERT, "GINZBURG_QUATAERT" }
};
